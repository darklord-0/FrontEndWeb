    ...
    return (
        <div>
                ...
                <div className="relative pa4 pa5-m">
                    ...
                    <div className="mb3">
                        <label type="username" className="db f6 white-80 ttu ph2 mb2">Username</label>
                    ...
                    <div className="mb4">
                        <label type="password" className="db f6 white-80 ttu ph2 mb2">Password</label>
                    ...
                    New Member? <p  onClick ={ () => onRouteChange('register')} className="white underline , pointer" href="/">Register</p>
                    </div>
                </div>
                </div>
        </div>
